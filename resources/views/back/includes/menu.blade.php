                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('home-banner.index') }}" class="dropdown-item">Banner</a>
                                            <a href="{{ route('home-about.create') }}" class="dropdown-item">About</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('back.about',['slug'=>'about']) }}" class="dropdown-item">ABOUT</a>
                                            <a href="{{ route('back.about',['slug'=>'mission']) }}" class="dropdown-item">MISSION</a>
                                            <a href="{{ route('back.about',['slug'=>'promise']) }}" class="dropdown-item">PROMISE</a>
                                            <a href="{{ route('back.about',['slug'=>'methods']) }}" class="dropdown-item">METHODS</a>
                                            <a href="{{ route('about.create') }}" class="dropdown-item">SLIDERS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
